(function($){
	...
	$(document).ready(function(){
		$('.list-post-like .elementor-grid .type-post:first-child').addClass('active');	
	    $('.list-post-like .elementor-grid .type-post').click(function() {
	        $(".list-post-like .elementor-grid .type-post").removeClass("active");
